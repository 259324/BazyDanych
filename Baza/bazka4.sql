...
--
-- Host: 127.0.0.1    Database: uczelnia
-- ------------------------------------------------------
...
INSERT INTO `kandydat` VALUES (1,1,90,2,1),(2,1,75,3,2);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `setkierunek`(id int, p_kierunek int )
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `setmatura`(id int, p_matura int )
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `setpesel`(id int, p_pesel varchar(255) )
BEGIN
...
-- Dump completed on 2023-06-21 15:57:00
